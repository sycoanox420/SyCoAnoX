...
\033[1;34;40m-----------------------------------------------
\33[1;33;40mM9D3 BY  :  𝙎𝙔𝙓𝙊 𝘼𝙉𝙊𝙓
\33[1;33;40mFacebook : https://www.facebook.com/SoFi.anox143
\033[1;32;40m Number :- +91 8302788872
\033[1;33;80 Rulex : 𝙎𝙔𝙓𝙊 𝘼𝙉𝙊𝙓
-----------------------------------------------"""
...
def login():
    ...
    sp("\33[1;33;40m[?] Enter the 2 factor code by google authenticator\n")
    print(47*'\033[1;37;1m-')
    apr = str(input('\033[1;32;40m[?] Enter Code : '))
    try:
...
def sendtextconvo(comment):
    ...
    print(">> 𝙎𝙔𝙓𝙊 𝘼𝙉𝙊𝙓 on FiRe :: ", yyy+ ' ' +line, "\n")

print("\033[1;33;40m", end = "")
os.system('clear')
print(logo)
sp("\33[1;33;40m[+] Login With Email/Number \n")
print(47*'\033[1;35;40m-')
...
print(47*'\033[1;35;40m-')
sp("\033[1;32;40m[?] Enter Chat/inbox Link\n")
print(47*'\033[1;35;40m-')
cid = str(input('"\33[1m\33[36m[?] Enter Link : '))
curl = 'https://m.facebook.com/messages/t/' + str(cid)

print("\033[1;34;40m", end = "")
print(47*'\033[1;35;40m-')
sp("\33[1;33;40m[?] Enter Notepad File Name\n")
print(47*'\033[1;35;40m-')
np = str(input('\033[1;32;40m[?] Enter File Name : '))
f = open(np, 'r')
lines = f.readlines()
f.close()
print("\033[1;33;40m", end = "")
...
print(47*'\\033[1;32;40m-')
sp("\33[1;33;40m[?] Enter The Time Delay In Seconds\n")
print(47*'\33[1;33;40m-')
t = int(input('\33[1;33;40m[?] Enter Time : '))
